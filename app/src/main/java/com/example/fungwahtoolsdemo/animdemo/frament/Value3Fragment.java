...
public class Value3Fragment extends BaseFragment implements View.OnClickListener, ValueAnimator.AnimatorUpdateListener {
    ...
    public void onAnimationUpdate(ValueAnimator animation) {
        ...
        img.setRotation(value1);
        img2.setRotation(value2);
        img3.setRotation(value3);
        img4.setRotation(value4);
